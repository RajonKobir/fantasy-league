...
// import 'package:fantasyleague/bloc/team_selection_bloc.dart';
...
// import 'package:fantasyleague/models/squads_response_data.dart';
// import 'package:fantasyleague/modules/create_team/playerProfile.dart';
// import 'package:fantasyleague/modules/create_team/teamPreview.dart';
// import 'package:fantasyleague/models/team_response_data.dart' as team;
// import 'package:fantasyleague/modules/my_teams/myTeams.dart';
...
//                                 boxShadow: <BoxShadow>[
//                                   BoxShadow(
//                                       color: AllCoustomTheme.getThemeData().primaryColor.withValues(alpha: 128), offset: Offset(0, 1), blurRadius: 5.0),
//                                 ],
//                               ),
//                               child: Material(
//                                 color: Colors.transparent,
...
//                                       borderRadius: new BorderRadius.circular(4.0),
//                                       boxShadow: <BoxShadow>[
//                                         BoxShadow(color: Colors.black.withValues(alpha: 128), offset: Offset(0, 1), blurRadius: 5.0),
//                                       ],
//                                     ),
//                                     child: Material(
//                                       color: Colors.transparent,
...
//                   color: AllCoustomTheme.getThemeData().dividerColor.withValues(alpha: 26),
//                   child: Center(
//                     child: Text(
...
//                             width: 0.4,
//                             child: Container(
//                               color: AllCoustomTheme.getTextThemeColors().withValues(alpha: 128),
//                             ),
//                           ),
//                           Container(
