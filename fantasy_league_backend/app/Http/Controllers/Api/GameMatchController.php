...
class GameMatchController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        $matches = GameMatch::with(['teamA', 'teamB', 'tournament', 'venue'])
            ->select(['id', 'team_a_id', 'team_b_id', 'tournament_id', 'start_time', 'status', 'venue_id'])
            ->paginate($perPage);
    ...
    {
        // include related team and players for convenience
    ...
    public function squads(GameMatch $gameMatch): JsonResponse
    {
        ...
        // Build squads from player_selections for this match (if any)
        $gameMatch->loadMissing(['teamA', 'teamB', 'venue']);

        $selections = \App\Models\PlayerSelection::with(['player', 'team'])
