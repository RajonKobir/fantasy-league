  ...
  <AdminLayout>
    ...
    <div class="max-w-2xl mx-auto py-8">
      ...
      <div class="bg-white shadow rounded-lg p-6 mb-6">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Payment Method</h1>
      ...
      <div class="bg-white shadow rounded-lg p-6">
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="flex gap-3 pt-6 border-t">
            ...
            >
              {{ form.processing ? 'Saving...' : 'Update Payment Method' }}
            </button>
            <Link
...
const hasChanges = computed(() => {
  return form.name !== props.paymentMethod.name ||
    form.code !== props.paymentMethod.code ||
    form.description !== props.paymentMethod.description ||
    form.is_active !== props.paymentMethod.is_active ||
    form.sort_order !== props.paymentMethod.sort_order
})
