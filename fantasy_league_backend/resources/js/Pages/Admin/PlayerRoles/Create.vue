...
function submit() {
  ...
  form.post(route('admin.player-roles.store'), {
    onError: (err) => {
  ...
  <AdminLayout>
    <div class="max-w-2xl mx-auto py-8">
      ...
      <div class="bg-white shadow rounded-lg p-6 mb-6">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Create Player Role</h1>
        <p class="text-gray-600">Add a new player role that can be assigned to players</p>
      </div>
