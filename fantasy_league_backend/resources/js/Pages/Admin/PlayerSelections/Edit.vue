...
const props = defineProps({ selection: Object, teams: Array, players: Array })
const form = useForm({
    team_id: props.selection.team_id,
    player_id: props.selection.player_id,
    captain: props.selection.captain,
    vice_captain: props.selection.vice_captain
})

const submit = () => form.put(`/admin/player-selections/${props.selection.id}`)
</script>

<template>
    <Head title="Edit Player Selection" />
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-800">Edit Player Selection</h2>
